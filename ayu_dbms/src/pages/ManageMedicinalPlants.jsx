  ...
  return (
    <div className="text-black w-full h-screen">
      ...
      <div className="bg-color-4 text-lg text-white p-6 w-2/3 m-auto my-24">
        <h1 className="text-3xl text-center font-serif">Manage Medicinal Plants</h1>
        <div className="mt-4">
          ...
          <input
            ...
            className="p-2 m-2"
          />
          <button onClick={handleAddPlant} className="bg-color-2 p-2 rounded-lg text-white">
            Add Plant
          </button>
        </div>
        <div className="mt-6">
          ...
          <ul>
            {plants.map((plant) => (
              <li key={plant.plant_id} className="flex justify-between">
                <span>{plant.name} - {plant.scientific_name} ({plant.family})</span>
                <button
