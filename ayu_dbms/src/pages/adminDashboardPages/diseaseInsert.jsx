  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex flex-grow mt-20 ">
        {/* Sidebar */}
        <aside className="bg-color-4 w-1/4 p-4 h-[calc(100vh-64px)] sticky top-0"> {/* Adjust height */}
          ...
          <nav className="space-y-4">
            ...
            <div className="group">
              ...
              <div className="hidden group-hover:block bg-color-3 rounded-lg mt-2 space-y-2">
                <a
                  href="/admin-medicinalPlant/insert"
                  className="block text-white px-4 py-2 hover:bg-color-2"
                >
                  Insert
                </a>
                <a
                  href="/admin-medicinalPlant/update"
                  className="block text-white px-4 py-2 hover:bg-color-2"
                >
                  Update
                </a>
                <a
                  href="/admin-medicinalPlant/view"
                  className="block text-white px-4 py-2 hover:bg-color-2"
                >
                  View
                </a>
                <a
                  href="/admin-medicinalPlant/delete"
                  className="block text-white px-4 py-2 hover:bg-color-2"
                >
                  Delete
                </a>
