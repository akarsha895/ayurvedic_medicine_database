...
function AdminNavbar() {
  return (
    ...
    <div className='mt-3'>
      <Link to="/admin-dashboard" className="text-white  text-lg font-semibold border-2 mb-1  p-2 rounded-lg border-color-2 hover:text-color-4 hover:border-color-5">View Dashborad</Link>
    </div>
  </nav>
  )
}
